...
const Navbar: React.FC<NavbarProps> = ({newRoomName, setNewRoomName, createRoom,}) => {
    ...
    return (
        <div className={`navbar-bg text-white p-4 flex justify-between items-center ${isScrolled ? 'sticky top-0 z-50' : ''}`}>

            {inChatRoom ? (<Link to="/"><span> Chat Rooms</span></Link>) : user ? (
                <div>
                    <input
                        type="text"
